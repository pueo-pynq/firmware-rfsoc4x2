# Ultrabasic project creation script
...
set _xil_proj_name_ "firmware-rfsoc4x2"
set _this_part xczu48dr-fsvg1517-2-e
...
# Create project
create_project ${_xil_proj_name_} $orig_proj_dir -part $_this_part
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part $_this_part -flow {Vivado Synthesis 2019} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part $_this_part -flow {Vivado Implementation 2019} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
